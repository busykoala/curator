...
const schema = z.object({
  ...
  LIDARR_URL: z.string().url().default("http://lidarr:8686"), LIDARR_API_KEY: z.string().default(""), OPENAI_API_KEY: z.string().default(""), CURATOR_AI_API_KEY: z.string().default(""),
  OPENAI_BASE_URL: optionalUrl, OPENAI_API_STYLE: z.enum(["responses","chat"]).default("responses"), OPENAI_MODEL: z.string().default(""),
...
export const versions = { taxonomy: 5, prompt: 6, normalization: 11, artwork: 8, identity: 5, providers: 4, categorizationSchema: 2, categorizationPrompt: 7, audioAnalysis: 3 };
