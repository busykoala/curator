...
export const enrichmentSchema = z.object({
  ...
  proposedTerms: z.array(z.object({ kind: z.enum(["genre", "style", "mood", "scene"]), name: z.string() })).max(8), evidenceNotes: z.array(z.string()).max(8),
});
export const enrichmentJsonSchema = {
  ...
  properties: {
    ...
    evidenceNotes: { type: "array", items: { type: "string" }, maxItems: 8 },
  },
} as const;
